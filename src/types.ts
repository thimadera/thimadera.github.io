...
export interface SkillCategory {
  ...
  /** Plain strings render as-is in both locales (e.g. tech names); use a
   * LocalizedString for entries that need translation (e.g. languages). */
  skills: (string | LocalizedString)[];
}
